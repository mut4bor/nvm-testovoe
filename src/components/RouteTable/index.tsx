...
const RouteTable = () => {
  ...
  return (
    <div className={style.routeTableContainer}>
      ...
      <p>Реализовать таблицу вывода списка маршрутов.</p>
      <p>
        Данные в таблице можно сортировать по любому из столбцов. Сортировка
        должна работать следующим образом:
      </p>
      <ul>
        <li>Адрес назначения – через сравнение IP-адресов</li>
        <li>Шлюз – через сравнение IP-адресов</li>
        <li>Интерфейс – через сравнение строк</li>
      </ul>
